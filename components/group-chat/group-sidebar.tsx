    ...
    <aside className="hidden w-[270px] shrink-0 flex-col border-r border-[#1F2937] bg-[#0F172A] lg:flex">
      ...
      <div className="px-5 pb-2 pt-3">
        <div className="flex items-center justify-between">
          <h2 className="text-[11px] font-black uppercase tracking-[0.16em] text-[#64748B]">Previous plans</h2>
            ...
            >
              <div className="mb-2 flex items-start justify-between gap-2">
                ...
                {confirmed ? (
                  ...
                  <Bookmark className="mt-0.5 size-3.5 shrink-0 text-[#FBBF24]" aria-hidden="true" />
                )}
              </div>
              <div className="flex items-center gap-2 text-[10px] font-bold text-[#64748B]">
                <span className={confirmed ? "text-[#34D399]" : "text-[#FBBF24]"}>
